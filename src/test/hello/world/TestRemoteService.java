...
public class TestRemoteService extends Activity
{
	...
	private void startService()
	{
		if (started)
		{
			Toast.makeText(TestRemoteService.this, "Service already started", Toast.LENGTH_SHORT).show();
		} else
		{
			Intent intent = new Intent("test.hello.world.CounterRemoteService");
			startService(intent);
			started = true;
			updateServiceStatus();
	...
	private void stopService()
	{
		if (!started)
		{
			Toast.makeText(TestRemoteService.this, "Service not yet started", Toast.LENGTH_SHORT).show();
		} else
		{
			Intent intent = new Intent("test.hello.world.CounterRemoteService");
			stopService(intent);
	...
	private void bindService()
	{
		...
		{
			Toast.makeText(TestRemoteService.this, "Cannot bind - service already bound", Toast.LENGTH_SHORT).show();
		}
	}
	...
	private void invokeService()
	{
		...
		} else
		{
			try
			{
				...
				Toast.makeText(TestRemoteService.this, "Counter is " + counter, Toast.LENGTH_LONG).show();
